...
# %%
INPUT_TXT_FILE='/scratch/users/giuliano.damian/text/4.5-df_code.txt'
...
class Config:
    ...
    APPLY_SMOTE=True
    OUTPUT_DIR='/scratch/users/giuliano.damian/text/5-final_analysis_df_output_default'
    OUTPUT_TXT=os.path.join(OUTPUT_DIR, '5-final_result_analysis.txt')
# %%
...
if __name__ == "__main__":
    if final_df.empty:
        ...
        execute_logistics_analysis(dataframe_input=final_df.copy(), apply_smote=False, filename_suffix='_without_SMOTE_LASSO')
        execute_logistics_analysis(dataframe_input=final_df.copy(), apply_smote=True, filename_suffix='_with_SMOTE_LASSO')
