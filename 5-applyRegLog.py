...
if __name__ == "__main__":
    if final_df.empty:
        ...
        execute_logistics_analysis(dataframe_input=final_df.copy(), apply_smote=False, filename_suffix='_without_SMOTE')
        execute_logistics_analysis(dataframe_input=final_df.copy(), apply_smote=True, filename_suffix='_with_SMOTE')
